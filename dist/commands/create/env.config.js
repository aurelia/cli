...
function createConfig(answers) {
    ...
    var configurations = {
        name: answers.name,
        level: answers.level };
    cli.store.config.paths.project = CWD + '/' + answers.projectPath, cli.store.config.paths.plugins = CWD + '/' + answers.pluginPath, cli.store.config.paths.templates = CWD + '/' + answers.templatePath;
