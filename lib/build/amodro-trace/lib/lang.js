...
exports.lang = void 0;
let isJavaObj, hasOwn = Object.prototype.hasOwnProperty;
...
class lang {
    ...
    static _mixin(dest, source, override) {
        var name;
        for (name in source) {
