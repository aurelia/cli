...
transform = {
    toTransport: function (namespace, moduleName, path, contents, onFound, options) {
        ...
        var astRoot, contentLines, modLine, foundAnon, scanCount = 0, scanReset = false, defineInfos = [], applySourceUrl = function (contents) {
            if (options.useSourceUrl) {
                contents = 'eval("' + lang_1.default.jsEscape(contents) +
    ...
    objectToString: function (obj, options, totalIndent) {
        ...
        if (obj === null) {
            ...
            value = quote + lang_1.default.jsEscape(obj) + quote;
        }
        else if (lang_1.default.isArray(obj)) {
            lang_1.default.each(obj, function (item, i) {
        ...
        else if (lang_1.default.isFunction(obj) || lang_1.default.isRegExp(obj)) {
            ...
            //An object
            lang_1.default.eachProp(obj, function (v, prop) {
                value += (first ? '' : ',' + lineReturn) +
                    nextIndent +
                    (keyRegExp.test(prop) ? prop : quote + lang_1.default.jsEscape(prop) + quote) +
                    ': ' +
