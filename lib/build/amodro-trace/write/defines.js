...
var falseProp = lang_1.lang.falseProp, getOwn = lang_1.lang.getOwn, makeJsArrayString = lang_1.lang.makeJsArrayString;
...
function defines(options) {
    ...
    return function (context, moduleName, filePath, _contents) {
        let namedModule, config = context.config, packageName = context.pkgsMainMap[moduleName];
        ...
        if (moduleName) {
            ...
            let amdProps = parse_1.parse.usesAmdOrRequireJs(filePath, contents);
...
function toTransport(context, moduleName, filePath, contents, onFound, options) {
    options = options || {};
    return transform_1.transform.toTransport('', moduleName, filePath, contents, onFound, options);
}
;
