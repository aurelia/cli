...
const cjs_1 = __importDefault(require("./amodro-trace/read/cjs"));
const es_1 = __importDefault(require("./amodro-trace/read/es"));
const all_1 = __importDefault(require("./amodro-trace/write/all"));
    ...
    transform() {
        ...
        if (path.extname(modulePath).toLowerCase() === '.json') {
            ...
            if (cache) {
                ...
                try {
                    contents = (0, cjs_1.default)(modulePath, this.contents, forceCjsWrap);
                }
                catch {
                    // file is not in amd/cjs format, try native es module
                    try {
                        contents = (0, es_1.default)(modulePath, this.contents);
                    }
                    catch (e) {
                ...
                const writeTransform = (0, all_1.default)(opts);
