...
module.exports = function(project) {
  // ? how to install specific version of Cypress here?
  // currently it installs "cypress@latest"
  project.addToDevDependencies('cypress', 'wait-on')

  // TODO copy Cypress files like cypress.json etc
