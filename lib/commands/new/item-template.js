...
exports.ItemTemplate = class {
  ...
  static jsonObject(name, jsonObject) {
    let item = new exports.ItemTemplate(name, false);
  ...
  static file(name) {
    return new exports.ItemTemplate(name, false);
  }

  static directory(name) {
    return new exports.ItemTemplate(name, true);
  }
}
