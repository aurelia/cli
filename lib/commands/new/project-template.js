...
exports.ProjectTemplate = class {
  ...
  configureDefaultContentStructure(content) {
    ...
    this.addToContent(
      ...
      ProjectItem.resource('setup.ext', 'test/setup.ext', this.model.transpiler)
    ).addToTasks(
      ...
      ProjectItem.resource('dev.ext', 'environments/dev.ext', this.model.transpiler),
      ProjectItem.resource('stage.ext', 'environments/stage.ext', this.model.transpiler),
      ProjectItem.resource('prod.ext', 'environments/prod.ext', this.model.transpiler)
