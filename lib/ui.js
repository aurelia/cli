...
const pretty_choices_1 = __importDefault(require("./pretty-choices"));
...
class ConsoleUI {
    ...
    async _question(question, options, defaultValue, _debug = []) {
        ...
        if (!options || typeof options === 'string') {
            ...
            opts = {
                ...
                choices: (0, pretty_choices_1.default)(options),
    ...
    getWidth() {
        return (0, get_tty_size_1.default)().width;
    }
    getHeight() {
        return (0, get_tty_size_1.default)().height;
    }
    async displayLogo() {
        if (this.getWidth() < 50) {
