'use strict';
const os = require('os');
const ApplicationTemplate = require('../../commands/new/application/project-template').ApplicationTemplate;
...
module.exports = class {
  ...
  execute(context) {
    ...
    let project = context.state.project = new ApplicationTemplate(model, this.options, this.ui);
