...
module.exports = class {
  ...
  execute(context) {
    ...
    let configurePlatform = require(`../../commands/new/platforms/${model.platform}`);
    configurePlatform(project);

    let configureTranspiler = require(`../../commands/new/transpilers/${model.transpiler}`);
    configureTranspiler(project);

    let configureCSSProcessor = require(`../../commands/new/css-processors/${model.cssProcessor}`);
    configureCSSProcessor(project);

    let configureEditor = require(`../../commands/new/editors/${model.editor}`);
